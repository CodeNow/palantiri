...
const subscribedTasks = {
  ...
  // TODO (deprecated) this one is legacy name, would be phased out
  'on-dock-unhealthy': require('./dock.lost')
}

const subscribedEvents = {
  'dock.disk.filled': require('./dock.disk.filled'),
  'dock.lost': require('./dock.lost'),
  'dock.memory.exhausted': require('./dock.remove'),
  'dock.unresponsive': require('./dock.remove'),
